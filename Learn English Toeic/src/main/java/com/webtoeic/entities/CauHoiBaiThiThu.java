...
public class CauHoiBaiThiThu {
	...
	@Column(name = "question", columnDefinition = "NVARCHAR(255)")
	private String question;
	
	@Column(name = "option1", columnDefinition = "NVARCHAR(255)")
	private String option1;
	
	@Column(name = "option2", columnDefinition = "NVARCHAR(255)")
	private String option2;
	
	@Column(name = "option3", columnDefinition = "NVARCHAR(255)")
	private String option3;
	
	@Column(name = "option4", columnDefinition = "NVARCHAR(255)")
	private String option4;
	
	@Column(name = "correctanswer", columnDefinition = "NVARCHAR(255)")
