...
//	console.log("id="+examId);
	...
	var url="http://localhost:8080/saveResultUser/"+examId+"/"+correctListening+"/"+correctReading;
...
function clickResutlReading(){
	...
	var url="http://localhost:8080/showResultReading/"+examId+"/"+countCorrect;
	if(window.XMLHttpRequest){
		xhttp = new XMLHttpRequest();
	}
	else{
...
//		var examId = $("#id_bai_exam").val();
//		
//		var url="http://localhost:8080/showResultReading/"+examId;
//		if(window.XMLHttpRequest){
//			xhttp = new XMLHttpRequest();
//		}
//		else{
