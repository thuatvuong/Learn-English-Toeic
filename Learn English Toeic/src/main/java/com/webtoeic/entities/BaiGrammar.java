...
public class BaiGrammar {
	...
	@Column(name = "tenbaigrammar", columnDefinition = "NVARCHAR(255)")
	private String tenbaigrammar;
	
	@Column(name = "anhbaigrammar")
	private String anhbaigrammar;
	
	@Column(columnDefinition = "NTEXT",name="content_HTML")
	private String contentHTML;
	
	@Column(columnDefinition = "NTEXT",name="content_MarkDown")
