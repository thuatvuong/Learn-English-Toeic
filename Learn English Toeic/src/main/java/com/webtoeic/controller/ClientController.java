...
@Controller
@SessionAttributes("loggedInUser") // gắn kết model Attributes với phiên session của người dùng nó sẽ được chứa thông tin của người dùng hiện tại được lưu trong cả session và model
